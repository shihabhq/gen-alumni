  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (profile.country !== originalProfile.country) {
        changedFields.country = profile.country;
      }
            ...
            {!isEditing ? (
              <>
                <button
                  ...
                  className="px-6 py-2 cursor-pointer rounded-lg font-semibold text-white transition-all"
                  style={{ backgroundColor: "#006747" }}
                >
                  Edit Profile
                </button>
            ...
            {isEditing ? (
              ...
              <div className="space-y-8">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                  ...
                  <button
                    className="font-semibold w-fit bg-emerald hover:bg-emerald-800 text-white px-5 py-2 cursor-pointer active:scale-95 transition-all rounded-sm"
